...
public class Main {
	...
	public static void main(String[] args) {
		...
		CommandFactory f;
		String[] factoryName = {"DrawShapeFactory","DeleteShapeFactory","CreateShapeFactory","CreateRectangleFactory"};
			...
			try {
				...
				switch (option) {
					...
					case 2:
						...
						break;
					case 3:
						c= new DeleteShapeCommand(shapes,index);
						c.execute();
						commandStack.push(c);
						break;
					case 4:
					...
					case 5:
						...
						c = new CreateRectangleCommand(shapes);
						c.execute();
						commandStack.push(c);
